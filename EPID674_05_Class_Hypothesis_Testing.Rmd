...
cor.test(nhanes_dataset$URXUAS, nhanes_dataset$nlr, method="spearman")
```

## Check your understanding
What is the relationship between urinary arsenic (LBXUAS) and neutrophil/lymphocyte ratio (nlr)? 
